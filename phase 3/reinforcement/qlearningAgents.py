...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        featuresVec = self.featExtractor.getFeatures(state, action)
        return sum([self.weights[f] * featuresVec[f] for f in featuresVec])
    ...
    def update(self, state, action, nextState, reward):
        ...
        for f in featuresVec:
            self.weights[f] += self.alpha * diff * featuresVec[f]
